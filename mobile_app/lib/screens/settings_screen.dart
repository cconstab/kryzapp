            ...
            child: Column(
              children: [
                ...
                _buildNumberField(
                  ...
                  onChanged: (value) => _updateConfig(
                    metricName,
                    config.copyWith(warningThreshold: value),
                  ),
                  helperText: 'Yellow indicator appears above this value',
                ),
                const SizedBox(height: 12),
                _buildNumberField(
                  ...
                  onChanged: (value) => _updateConfig(
                    metricName,
                    config.copyWith(criticalThreshold: value),
                  ),
                  helperText: 'Red indicator appears above this value',
                ),
                const SizedBox(height: 12),
                _buildTextField(
                  label: 'Unit',
